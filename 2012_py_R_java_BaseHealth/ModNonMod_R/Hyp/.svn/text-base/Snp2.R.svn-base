...
for (Did in names(PrevD) )
{
	#Redirect output to a file
	cat('====', paste(as.character(Report[[Did]]), "/", Did, "_GenCalcReport_2.txt", sep=""), '====', '\n')
	sink(paste(as.character(Report[[Did]]), "/", Did, "_GenCalcReport_2.txt", sep=""), append=FALSE, split=TRUE)
