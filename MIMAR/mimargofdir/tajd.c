/************************* tajima.c *************************************************************
 This program calculates Tajima's D when number of sequences, number of segregating sites,
   and average pairwise differences (pi) are known.
 This file has not been changed from the filr available with ms.
 See Tajima's initial paper for details (in Genetics 1989).
**************************************************************************************************/
...
{
  // nsam: number of samples, segsites: number of polymorphic sites in a population, sumk: pi
  double a1=0.0, a2=0.0, b1=0.0, b2=0.0, c1=0.0, c2=0.0, e1=0.0, e2=0.0; 
