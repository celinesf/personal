/************ rand2.c - mimar *******************************************
 *  Link in this file for random number generation using rand().
...
#include <stdlib.h>
#include <math.h>
#include "mimarsim.h"   /* Celine changed 03/18/2010 */
...
void seedit(const char *flag, FILE *pf, struct params *p)
{
  FILE *fopen(const char *,const char *), *pfseed=NULL;
  unsigned int seed2=0,i;

  if(flag[0]=='s')
    {
      pfseed=fopen("seedmimar","r");
