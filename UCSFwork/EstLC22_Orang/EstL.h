...
*/
void Inverse(
             long double **a,//!<matrix to invert
             long double **inv,//!< returned inverse matrix
...
*/
void CoFactor(
              long double **a, //!<matrix to get cofactor
              int n,//!<# statistics in cov matrix
              long double **b//!< returned matrix of cofactors
              );
...
*/
void Transpose(
              long double **a,//!< matrix to transpose
              long double **m,//!< returned Transpose
               int n//!<# statistics in cov matrix
               );
