  ...
  for(s in 1:length(summaries[[1]]))
    {
      ...
      {tp=c("WARNING: I found an unknown summary statistic in the list I should concider: ",summaries[[1]][s], ", I am therefore ignoring it."); stp=c("'","'","'","'"); error_message(tp,stp);}
    }# loop on stats provided
